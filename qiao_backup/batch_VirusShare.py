...
from embedding_VirusShare import to_arff_for_label
from embedding_VirusShare import csv2arff

path1 = '/home/rtfeng/fei/jdk-17.0.1/bin/java'
meka_classpath = r'/home/rtfeng/fei/meka-release-1.9.2/lib/'#MEKA
meka_classifiers = ['CDN']
weka_classifiers = ['trees.REPTree']
...
def main():
    ...
    feature_num = 531
    title = '@relation \'unlabled: -C 6\''
    f_batch = open('/home/rtfeng/fei/qiao_newdata2/batch_VirusShare/CDN_REPTree_8/batch.csv', 'w')
    f_batch.write('batch,acc,data,epoch')
    f_batch.write('\n')
    g_batch = 0
    g_acc = 0
    g_data = 0
    ...
    for meka_c in meka_classifiers:
        for weka_c in weka_classifiers:
            ...
            for batch_size in [8]:
                ...
                print(dir_r)
                save_path = '/home/rtfeng/fei/'+pn+'/result_VirusShare/' + dir_r #存放结果
                mkdir(save_path)
                ...
                for batch in range(5456//batch_size):
                    g_batch += 1
            ...
            model_folder = 'CDN_REPTree_8'
            result_base = '/home/rtfeng/fei/'+pn+'/result_VirusShare'
            ...
            if True:
                ...
                length = del_input_4000('/home/rtfeng/fei/'+pn+'/data/VirusShare_5000.csv', del_path, del_out_path)
            
            test_path = base_path + '/test/manual_test.arff'
            save_path = '/home/rtfeng/fei/'+pn+'/result2_VirusShare/' + model_folder  #  -----------------------------------------------------
            mkdir(save_path)
