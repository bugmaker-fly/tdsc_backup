...
def merge_x_y(path1, temp_train_data_y):
    ...
    path_out = '/home/rtfeng/fei/qiao_newdata_backup/data/train_temp_xy.csv'
    f_w = open(path_out, 'w')
...
def merge_csv(path1, path2, args):
    ...
    return_path = '/home/rtfeng/fei/qiao_newdata_backup/data/temp_train_data.csv'
...
def merge_csv2(path1, path2):
    ...
    f_path1 = open(path1, 'r', encoding='utf-8')
    f_path2 = open(path2, 'r', encoding='utf-8')
    return_path = '/home/rtfeng/fei/qiao_newdata_backup/data/temp_train_data_shuffle.csv'
    f_out_path = open(return_path, 'w')
    writer = csv.writer(f_out_path, lineterminator='\n')
    flag = False
    id = []
...
def main():
    ...
    #全局变量
    base_path = '/home/rtfeng/fei/qiao_newdata_backup/data'
    f_feature = base_path + '/final_feature_500.txt'
    label_num = 6
    feature_num = 531
    title = '@relation \'unlabled: -C 6\''

    result_base = '/home/rtfeng/fei/qiao_newdata_backup/result'
    model_begin_l = ['CDT_RandomForest_8','BR_RandomForest_8']
    acc_begin_l = [0.833,0.8]
    ...
    for i, model_folder in enumerate(model_begin_l):
        ...
        if True:
            ...
            length = del_input_4000('/home/rtfeng/fei/qiao_newdata_backup/data/input_derbin_new.csv', del_path, del_out_path)
            ...
            save_path = '/home/rtfeng/fei/qiao_newdata_backup/result2/' + model_folder  # 存放结果 -------------------------------改了这里----------------------
            mkdir(save_path)
