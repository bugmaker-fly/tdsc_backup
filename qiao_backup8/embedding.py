...
f_feature = '/home/rtfeng/fei/qiao_backup8/data/final_feature_500.txt'
...
def read_batch(batch,batch_size):
    f_train = open('/home/rtfeng/fei/qiao_backup8/data/train_temp.csv', 'w', encoding='utf-8')  #暂定训练集csv存放位置
    writer = csv.writer(f_train,lineterminator='\n')


    f_4000 = open('/home/rtfeng/fei/qiao_backup8/data/input_derbin_new.csv', 'r', encoding='utf-8')
    ...
    path = '/home/rtfeng/fei/qiao_backup8/data/train_temp.csv'
    return path
