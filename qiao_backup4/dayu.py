...
meka_classifiers = ['CC','BR','CDN','BR']
weka_classifiers = ['trees.REPTree','trees.LMT','trees.J48','trees.RandomForest']
...
def main():
    ...
    for i, meka_c in enumerate(meka_classifiers):
        if True:
            meka_classifier = 'meka.classifiers.multilabel.' + meka_c
            weka_c = weka_classifiers[i]
            ...
            print(f'meka:{meka_classifier} weka:{weka_classifier}')
            ...
            for batch_size in [8]:
                ...
                print(dir_r)
                save_path = '/home/rtfeng/fei/qiao_newdata_backup/result/' + dir_r #存放结果
                mkdir(save_path)
