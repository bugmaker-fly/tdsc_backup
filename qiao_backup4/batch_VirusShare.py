...
def main():
    ...
    feature_num = 531
    title = '@relation \'unlabled: -C 6\''
    f_batch = open('/home/rtfeng/fei/qiao_newdata2/batch_VirusShare/RAkELd_RandomForest_8/batch.csv', 'w')
    ...
    for meka_c in meka_classifiers:
        for weka_c in weka_classifiers:
            ...
            model_folder = 'RAkELd_RandomForest_8'
