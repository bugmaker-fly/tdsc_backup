...
f_feature = 'E:\lab_related\mycode\qijing_qiao385\data\\final_feature_500.txt'
...
def read_batch(batch,batch_size):
    f_train = open('E:\lab_related\mycode\qijing_qiao385\data\\train_temp.csv', 'w', encoding='utf-8')  #暂定训练集csv存放位置
    writer = csv.writer(f_train,lineterminator='\n')


    f_4000 = open('E:\lab_related\mycode\qijing_qiao385\data\del_input_4000_shuffle.csv', 'r', encoding='utf-8')
    ...
    path = 'E:\lab_related\mycode\qijing_qiao385\data\\train_temp.csv'
    return path
