...
meka = Meka(
    meka_classifier="meka.classifiers.multilabel.CDT",  # Binary Relevance: classifier chains
...
def merge_x_y(path1, temp_train_data_y):
    ...
    path_out = '/home/rtfeng/fei/qiao_backup2/data/train_temp_xy.csv'
    f_w = open(path_out, 'w')
...
def merge_csv(path1, path2, args):
    ...
    return_path = '/home/rtfeng/fei/qiao_backup2/data/temp_train_data.csv'
...
def merge_csv2(path1, path2):
    ...
    f_path1 = open(path1, 'r', encoding='utf-8')
    f_path2 = open(path2, 'r', encoding='utf-8')
    return_path = '/home/rtfeng/fei/qiao_backup2/data/temp_train_data_shuffle.csv'
    f_out_path = open(return_path, 'w')
    writer = csv.writer(f_out_path, lineterminator='\n')
    flag = False
    id = []
...
def get_model(train_path, test_path1, test_path2, args):
    ...
    #保存模型
    model_path = '/home/rtfeng/fei/qiao_backup2/test_stability_result/CDT_LMT_8/model' + '/model'  + '.pkl'
    ...
    return acc1, hammingloss, oneerror, instancef1, model_path
...
def main():
    ...
    result_path = '/home/rtfeng/fei/qiao_backup2/test_stability_result'
    ...
    train_temp_csv = result_path + '/CDT_LMT_8/best_train_set_now_3.csv'
    del_csv = result_path + '/train_and_test.csv'
    train_csv = result_path + '/CDT_LMT_8/train_csv.csv'
    len = del_input_4000(train_temp_csv, del_csv, train_csv)

    train_arff = csv2arff(train_csv, f_feature, feature_num+label_num)
    acc1, hamming_loss, one_error, instance_f1, model = get_model(train_arff, test_path1,test_path2, args)
    print(f'acc1:{acc1}')
