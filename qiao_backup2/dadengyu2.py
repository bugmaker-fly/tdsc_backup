...
def main():
    ...
    #全局变量
    base_path = '/home/rtfeng/fei/qiao_backup2/data'
    f_feature = base_path + '/final_feature_500.txt'
    label_num = 6
    feature_num = 531
    title = '@relation \'unlabled: -C 6\''

    result_base = '/home/rtfeng/fei/qiao_backup2/result2'
    model_begin_l = ['CDN_J48_8']
    acc_begin_l = [0.9]
    ...
    for i, model_folder in enumerate(model_begin_l):
        ...
        if True:
            ...
            length = del_input_4000('/home/rtfeng/fei/qiao_backup2/data/input_derbin_new.csv', del_path, del_out_path)
            ...
            save_path = '/home/rtfeng/fei/qiao_backup2/result_epoch/' + model_folder  # 存放结果 -------------------------------改了这里----------------------
            mkdir(save_path)
