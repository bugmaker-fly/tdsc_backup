...
f_feature = 'D:\lab_related\my_code\qiao_newdata\data' + '\\final_feature_500.txt'
...
def read_batch(batch,batch_size):
    f_train = open('D:\lab_related\my_code\qiao_newdata\data\\train_temp.csv', 'w', encoding='utf-8')  #暂定训练集csv存放位置
    writer = csv.writer(f_train,lineterminator='\n')


    f_4000 = open('C:\\Users\张飞\Desktop\\file_temp\input_VirusShare.csv', 'r', encoding='utf-8')
    ...
    path = 'D:\lab_related\my_code\qiao_newdata\data\\train_temp.csv'
    return path
