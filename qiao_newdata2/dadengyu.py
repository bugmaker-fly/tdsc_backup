...
def merge_x_y(path1, temp_train_data_y):
    ...
    path_out = '/home/rtfeng/fei/qiao_newdata2/data/train_temp_xy.csv'
    f_w = open(path_out, 'w')
...
def merge_csv(path1, path2, args):
    ...
    return_path = '/home/rtfeng/fei/qiao_newdata2/data/temp_train_data.csv'
...
def merge_csv2(path1, path2):
    ...
    f_path1 = open(path1, 'r', encoding='utf-8')
    f_path2 = open(path2, 'r', encoding='utf-8')
    return_path = '/home/rtfeng/fei/qiao_newdata2/data/temp_train_data_shuffle.csv'
    f_out_path = open(return_path, 'w')
    writer = csv.writer(f_out_path, lineterminator='\n')
    flag = False
    id = []
...
def main():
    ...
    parse.add_argument('--label_count', default=6, type=int,
                       help='label的维度')
    parse.add_argument('--random_seed', default=600, type=int,
                       help='随机种子')
    ...
    result_base = '/home/rtfeng/fei/qiao_newdata2/result2'
    model_begin_l = ['CDN_REPTree_8']
    acc_begin_l = [0.866]
    ...
    for i, model_folder in enumerate(model_begin_l):
        ...
        if True:
            ...
            length = del_input_4000('/home/rtfeng/fei/qiao_newdata2/data/input_derbin_new.csv', del_path, del_out_path)
            ...
            save_path = '/home/rtfeng/fei/qiao_newdata2/result_epoch/' + model_folder  # 存放结果 -------------------------------改了这里----------------------
            mkdir(save_path)
