...
def main():
    ...
    result_base = '/home/rtfeng/fei/qiao_newdata_backup/result2'
    model_begin_l = ['BR_RandomForest_8']
    acc_begin_l = [0.8]
    ...
    for i, model_folder in enumerate(model_begin_l):
        ...
        if True:
            ...
            save_path = '/home/rtfeng/fei/qiao_newdata_backup/result_epoch/' + model_folder  # 存放结果 -------------------------------改了这里----------------------
            mkdir(save_path)
